// extracts num_threads, runtime and utility from files with names of the form method3_output_?.txt where ? is the number of threads
...
int main(int argc, char** argv) {
  ...
  string filename = "method3_runtime_utility";
  ...
  {
    outputfile_name = "method3_output_"+to_string(i);
    double runtime;
